window.__ModuleLoader__.load({
  ...
  factory: () => {
    ...
    const { Button, Menu, IconChevronDownOutline14 } = api.primitives;
    ...
    return { default: { async activate(context) {
      ...
      const lease = ui.register({
        descriptor: { id: "session-title", surface: { apiVersion: 'plugins.starpivot.dev/v1', kind: 'WebPlugin' }, content: {} },
